"""
Django settings for broken_union_dev_133404 project.
...
ROOT_URLCONF = 'broken_union_dev_133404.urls'
...
WSGI_APPLICATION = 'broken_union_dev_133404.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_union_dev_133404 API",
    "DESCRIPTION": "API documentation for broken_union_dev_133404 App",
    "VERSION": "v1",
}
